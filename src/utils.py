...
def load_movielens100k(path="data/ml-100k/u.data",
                       ...
                       seed=0):
    """
    Load MovieLens-100K from u.data file and create an 80/20 train/test split.
    """
...
def load_movielens1m(path="data/ml-1m/ratings.dat",
                     ...
                     seed=0):
    """
    Load MovieLens-1M and create an 80/20 train/test split.
    """
    df = pd.read_csv(
...
def load_dataset(name, **kwargs):
    ...
    **kwargs : dict
    ...
    if name == "ml-100k":
        ...
        raise ValueError(f"Unknown dataset '{name}'. Choose from 'ml-100k', 'jester2', 'ml-1m'.")
