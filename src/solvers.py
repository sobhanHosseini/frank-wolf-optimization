...
# ----------------------------------------------------------------
# Frank–Wolfe solver with logging and controlled snapshots
# ----------------------------------------------------------------
class FrankWolfe:
    def __init__(
        self,
...
# ----------------------------------------------------------------
# Pairwise Frank–Wolfe with optimized away selection and controlled snapshots
# ----------------------------------------------------------------
    ...
    def run(self, X0=None):
        ...
        for t in trange(self.max_iter, desc='Pairwise-FW'):
            ...
            if alpha_max<=0:
                ...
                weights[idx_S]+=gamma; weights[idx_away]-=gamma
